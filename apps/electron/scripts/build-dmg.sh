...
echo "=== Building Analyst Agent DMG (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder.yml uses artifactName to output: Analyst-Agent-${arch}.dmg
DMG_NAME="Analyst-Agent-${ARCH}.dmg"
