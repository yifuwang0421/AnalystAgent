...
echo "=== Building Analyst Agent AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Analyst-Agent-x86_64.AppImage or Analyst-Agent-aarch64.AppImage
BUILT_APPIMAGE_NAME="Analyst-Agent-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Analyst-Agent-x64.AppImage, Analyst-Agent-arm64.AppImage
APPIMAGE_NAME="Analyst-Agent-${ARCH}.AppImage"
