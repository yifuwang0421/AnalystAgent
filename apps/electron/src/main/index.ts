...
// Supports multi-instance dev: CRAFT_APP_NAME env var (e.g., "Analyst Agent [1]")
app.setName(process.env.CRAFT_APP_NAME || 'Analyst Agent')
app.setAppUserModelId('com.lukilabs.analyst-agent')
