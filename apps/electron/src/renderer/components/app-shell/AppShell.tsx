...
function AppShellContent({
  ...
  const [collapsedItems, setCollapsedItems] = React.useState<Set<string>>(() => {
    ...
    return new Set(['nav:session-secondary'])
  })
  ...
  React.useEffect(() => {
    ...
    if (previousWorkspaceId !== activeWorkspaceId) {
      ...
      setCollapsedItems(newCollapsedItems !== null ? new Set(newCollapsedItems) : new Set(['nav:session-secondary']))
    }
  ...
  const unifiedSidebarItems = React.useMemo((): SidebarItem[] => {
    ...
    return result
  }, [handleFilesClick, handleAgentsClick, handleSkillsClick, handleSourcesClick, handleAutomationsClick, handleSettingsClick])
          ...
          sidebarSlot={
            ...
            <div className="flex h-full flex-col select-none">
              ...
              <div className="flex-1 flex flex-col min-h-0">
                {/* New Session is a primary action, visually separated from navigation. */}
