 ...
 * Shows both default patterns (from ~/.analyst-agent/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.analyst-agent/permissions/default.json.
...
/**
 * Build default permissions data from ~/.analyst-agent/permissions/default.json.
