...
const EXPECTED_CHANNELS: string[] = [
  ...
  'drafts:getAll',
  'drafts:set',
  'file:createWorkspaceResearchItem',
  'file:deleteWorkspaceResearchItem',
  'file:generateThumbnail',
  'file:listWorkspaceResearchFiles',
  'file:openDialog',
  'file:read',
  'file:readAttachment',
  'file:readBinary',
  ...
  'file:searchWorkspaceKnowledge',
  'file:storeAttachment',
  'file:writeWorkspaceMarkdown',
  'fs:listDirectory',
  'fs:search',
  'git:getBranch',
  'gitbash:browse',
