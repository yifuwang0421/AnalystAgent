...
Use `browser_tool` to control built-in browser windows (Chromium) inside Analyst Agent.
...
- Before first browser tool usage, the agent must read this guide (`~/.analyst-agent/docs/browser-tools.md`).
