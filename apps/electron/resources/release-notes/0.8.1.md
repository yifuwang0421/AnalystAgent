...
- **Artifact naming consistency** — Build scripts, CI workflows, install scripts, docs, and download links now consistently use the plural `Analyst-Agent-*` artifact naming.
...
- **Docker defaults** — Fixed Dockerfile and Compose defaults around `.analyst-agent` directory ownership, ports, and volume behavior for self-hosted server setups.
