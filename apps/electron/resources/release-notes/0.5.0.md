...
- **Skill metadata** — `requiredSources` and `icon` are now displayed in the skill info page and accepted by validation (#290, #249)
...
- **Explore mode** — Blocked `find -exec` and similar shell escape vectors (#272)
