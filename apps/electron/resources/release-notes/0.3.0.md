...
Analyst Agent now renders diagrams natively using beautiful-mermaid — our new open-source Mermaid rendering engine. No external dependencies, no browser DOM, just pure TypeScript.
