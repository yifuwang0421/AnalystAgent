...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.analyst-agent/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.analyst-agent/docs/` | Always overwrite on launch |
| `themes/` | `~/.analyst-agent/themes/` | Always overwrite on launch |
| `permissions/` | `~/.analyst-agent/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.analyst-agent/tool-icons/` | Always overwrite on launch |
| `release-notes/` | `~/.analyst-agent/release-notes/` | Always overwrite on launch |
| `config-defaults.json` | `~/.analyst-agent/config-defaults.json` | Always overwrite on launch |
