...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      // Keep renderer builds on electron-log's renderer entry. Vite's dep optimizer
      // can otherwise resolve the package through its Node entry, which pulls in
      // builtins such as https and leaves the Electron window stuck on loading.
      'electron-log/renderer': resolve(__dirname, '../../node_modules/electron-log/renderer.js'),
      'electron-log': resolve(__dirname, '../../node_modules/electron-log/renderer.js'),
    },
