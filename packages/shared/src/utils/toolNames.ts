...
const TOOL_DISPLAY_NAMES: Record<string, string> = {
  ...
  'Task': 'Running Agent',
  'Agent': 'Running Agent',
  'spawn_session': 'Spawning Subagent',
  'analyst_orchestrate': 'Dispatching Subagents',
  'analyst_validate_workflow': 'Validating Research Workflow',
  ...
  // Documentation tools
  'SearchAnalystAgent': 'Search Documentation',
};
