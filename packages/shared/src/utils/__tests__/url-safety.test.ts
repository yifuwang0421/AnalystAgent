...
describe('classifyExternalUrl — internal deep links', () => {
  it('classifies analystagent:// as internal-deeplink', () => {
    expect(classifyExternalUrl('analystagent://settings').kind).toBe('internal-deeplink')
  })
...
describe('isSafeExternalUrl', () => {
  ...
  it('returns false for internal deep links', () => {
    expect(isSafeExternalUrl('analystagent://settings')).toBe(false)
  })
