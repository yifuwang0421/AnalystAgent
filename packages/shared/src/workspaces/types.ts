...
export type FinanceDataProvider = 'ifind' | 'none';

/**
 * Finance analyst workspace configuration.
 * Research content remains file-backed in a user-visible workspace folder.
 */
