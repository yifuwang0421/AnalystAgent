 ...
 * Default location: ~/.analyst-agent/workspaces/
 */
...
const CONFIG_DIR = join(homedir(), '.analyst-agent');
...
/**
 * Get the default workspaces directory (~/.analyst-agent/workspaces/)
 */
 ...
 * @param baseDir - Parent directory where workspace folders live (e.g., ~/.analyst-agent/workspaces/)
 ...
 * Returns paths to valid workspaces found in ~/.analyst-agent/workspaces/
 */
