 ...
 *
 * Loads release notes from bundled assets and syncs them to ~/.analyst-agent/release-notes/.
...
function loadBundledReleaseNotes(): Record<string, string> {
  ...
  // Try bundled assets first, fall back to ~/.analyst-agent/release-notes/
