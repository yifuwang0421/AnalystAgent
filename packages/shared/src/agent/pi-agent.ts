...
// System prompt for Analyst Agent context
...
export class PiAgent extends BaseAgent {
  protected backendName = 'Analyst Agent Backend';
  ...
  private handleSubprocessEvent(event: Record<string, unknown>): void {
    ...
    // Feed them through PiEventAdapter to convert to Analyst AgentEvents.
  ...
  protected async *chatImpl(
    ...
    try {
      ...
      const systemPrompt = getSystemPrompt(
        ...
        'Analyst Agent Backend', // backendName
