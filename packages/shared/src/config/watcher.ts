 ...
 *
 * Watched paths:
 * - ~/.analyst-agent/config.json - Main app configuration
 * - ~/.analyst-agent/preferences.json - User preferences
 * - ~/.analyst-agent/theme.json - App-level theme overrides
 * - ~/.analyst-agent/themes/*.json - Preset theme files (app-level)
 * - ~/.analyst-agent/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.analyst-agent/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.analyst-agent/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.analyst-agent/permissions/)
