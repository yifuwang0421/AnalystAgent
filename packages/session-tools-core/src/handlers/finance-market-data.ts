...
export type FinanceProvider = 'auto' | 'ifind' | 'yfinance' | 'edgartools' | 'akshare' | 'baostock' | 'python';
...
const PYTHON_PROVIDERS = new Set<FinanceProvider>(['python', 'yfinance', 'edgartools', 'akshare', 'baostock']);
