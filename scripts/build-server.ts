#!/usr/bin/env bun
/**
 * Build script for standalone Analyst Agent server.
 *
...
function showHelp(): void {
  console.log(`
Standalone server build script for Analyst Agent
...
# Analyst Agent Server — convenience entry point
...
echo "=== Analyst Agent Server Setup ==="
echo ""
...
[Unit]
Description=Analyst Agent Server
...
async function main(): Promise<void> {
  ...
  console.log(`=== Building Analyst Agent Server ${version} for ${platform}-${arch} ===`);
