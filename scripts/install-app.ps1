...
# Usage: irm https://github.com/yifuwang0421/AnalystAgent/install-app.ps1 | iex
...
if (-not $filename) {
    $filename = "Analyst-Agent-$arch.exe"
}
...
$process = Get-Process -Name "Analyst Agent" -ErrorAction SilentlyContinue
if ($process) {
    Write-Info "Closing Analyst Agent..."
...
Write-Host ""
Write-Host "  Analyst Agent has been installed."
Write-Host ""
